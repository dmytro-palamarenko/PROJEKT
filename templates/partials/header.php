    ...
    <div class="carousel-item active">
      <div class="row ">
				<div class="col-md-6 taital">
					<h1 class="taital">Quality<strong class="banner_taital">Products with breads sweet Den</strong></h1>
				...
				<div class="col-md-6">
					<div class="banner-image"><img src="../assets/images/banner-image.png" style="max-width: 100%;"></div>
				</div>
				<div class="banner_bt">
